            ...
            publicSubCommand(::CarryTypeCreateArguments) {
                ...
                action {
                    respond {
                        ...
                        if (CarryTypeConnection.getInstance(guild!!.id.value.toLong())
                        ...
                        val carryTypeModel = CarryTypeConnection.getInstance(guild!!.id.value.toLong())
            ...
            publicSubCommand(::CarryTypeArguments) {
                ...
                action {
                    respond {
                        ...
                        val deletedCarryType = CarryTypeConnection.getInstance(carryType.get().server.id)
            ...
            publicSubCommand(::CarryTypeEditArguments) {
                ...
                action {
                    respond {
                        ...
                        val updatedCarryType = CarryTypeConnection.getInstance(guild!!.id.value.toLong())
