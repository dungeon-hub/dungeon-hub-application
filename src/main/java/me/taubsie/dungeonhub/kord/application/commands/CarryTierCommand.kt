            ...
            publicSubCommand(::CarryTierCreateArguments) {
                ...
                action {
                    respond {
                        ...
                        if (CarryTierConnection.getInstance(carryType).getByIdentifier(identifier).isPresent) {
                ...
                action {
                    respond {
                        ...
                        if (arguments.category != null) {
                            val categoryCarryTier = DiscordServerConnection.getInstance()
                                .getCarryTierFromCategory(
                                    guild!!.id.value.toLong(),
                                    arguments.category!!.id.value.toLong()
                                )
                        ...
                        val updatedCarryTier = CarryTierConnection.getInstance(carryType)
