 ...
 * @since 1.0.0
 */
public class StartMainBot extends StartBot
{
    ...
    {
        return IdList.APPROVING_CHANNEL.getID();
    }
    ...
    public List<Role> getAllowedRolesForDiscardOthers(Server server)
    {
        ...
        allowedRoles.add(server.getRoleById(723321101392019518L).orElse(null));
