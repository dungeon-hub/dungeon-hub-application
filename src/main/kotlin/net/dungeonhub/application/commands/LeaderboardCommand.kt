            ...
            publicSubCommand {
                ...
                action {
                    ...
                    if (firstPage == null || firstPage.totalPages == 0) {
                        respond {
                            embeds = mutableListOf(StaticMessageService.getEmptyReputationLeaderboardEmbed(leaderboardTitle))
                        }
                        return@action
                    }
                    ...
                    respondingPaginator {
                        ...
                        for (i in 0..<firstPage.totalPages) {
                            ...
                            page(
                                Page {
                                    val embed = StaticMessageService.getReputationEmbed(leaderboardTitle, leaderboardModel)
